...
import { Header, Filter, FilterInput, Post } from "../../components";
            ...
            <div className="filterBoxGroup">
                <div className="filterBox">
                    <div className="searchFilter">
                        <Filter className={'selectGroup selectJob selectLeft'} mainClassName={'selectJob'} selectBase={'직무'} option={['프론트엔드', '백엔드', 'AI']} result={[setResult, setBackground, setText]} open={[open, setOpen]} />
                        ...
                        <FilterInput className={'selectGroup selectRight'} mainClassName={'selectCompany'} inputClassName={'selectBase selectInput selectCompany'} placeholder={'기술 명'} result={[setResult, setBackground, setText]} />
                    </div>
                    ...
                    <div className="searchFilter">
                        ...
                        <Filter className={'selectGroup selectPay selectMiddle'} mainClassName={'selectPay'} selectBase={'급여'} option={['1000만원 이상', '2000만원 이상', '3000만원 이상', '4000만원 이상', '5000만원 이상']} result={[setResult, setBackground, setText]} open={[open, setOpen]} />

                        <Filter className={'selectGroup selectCareer selectRight'} mainClassName={'selectCareer'} selectBase={'경력'} option={['1년이상', '2년이상', '3년이상']} result={[setResult, setBackground, setText]} open={[open, setOpen]} />
                    </div>
